...
<head>
     ...
     <script type="text/javascript">
      ...
      var str="";
      function Search() { //以地圖類型調閱出該類型資料
				db.collection("style").where('類型','==',name).get().then(querySnapshot => {

          querySnapshot.forEach(doc => {
            
            str += "<div class=\"row gtr-200\" style=\"text-align: justify;text-justify:inter-ideograph;\"><div class=\"col-6 col-12-medium\"><header class=\"major\"><h4>"+doc.data()["地圖"]+"</h4></header>規則："+doc.data()["規則"]+"<br />提示："+doc.data()["提示"]+
            "<br /><br /></div><div class=\"col-6 col-12-medium\"><span class=\"image fit\"><img src=\"images/"+doc.data()["地圖"]+".png\"></span></div></div>";
        ...
        <script>
          ...
          report();
				...
				<!-- Note: The "styleN" class below should match that of the header element. -->
					<section id="banner" class="style2">
						<div class="inner">
							...
							<div class="content">
								<p>歡迎使用我的詳細服務，目前所在位置為「<?php echo $map?>」類型關卡！<br />
                如果要閱覽其他關卡可以點選下方按鈕前往唷💕</p>
							</div>
						</div>
					</section>
				...
				<!-- Main -->
                  ...
                  <a href="detail.php?id=競速" class="button">競速</a>
                  <a href="detail.php?id=生存" class="button">生存</a>
                  <a href="detail.php?id=動腦" class="button">動腦</a>
                  <a href="detail.php?id=捕獵" class="button">捕獵</a>
                  <a href="detail.php?id=合作" class="button">合作</a>
                  <a href="detail.php?id=最終回合" class="button">最終回合</a><hr>
                  
                  <span id="display"><span>
                  
                  </div>
                  <center><a href="raiders.php" class="button primary icon solid fa-book">攻略 Raider</a></center><br /><br />
                </div>
